...
subprojects {
  ...
  tasks.withType<Test>().configureEach {
    ...
    // inputs it takes.
    listOf("poToken", "poTokenBinding", "visitorData", "playerPoToken", "poTokenInUrl", "clientInfo", "sabrEndpoint", "ustreamerConfig", "sabrAudio", "describeBuffer", "paced", "playbackPosition", "readaheadMs").forEach { name ->
