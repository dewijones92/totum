...
subprojects {
  ...
  tasks.withType<Test>().configureEach {
    ...
    // inputs it takes.
    listOf("poToken", "poTokenBinding", "visitorData", "playerPoToken", "poTokenInUrl", "clientInfo", "sabrEndpoint", "ustreamerConfig", "sabrAudio", "sabrEndpoint2", "ustreamerConfig2", "describeBuffer", "paced", "playbackPosition", "readaheadMs", "sentinelRange", "stickyResolution", "tracks", "java.net.preferIPv4Stack", "sabrUserAgent").forEach { name ->
